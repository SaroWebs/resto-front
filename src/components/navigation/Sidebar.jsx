...
const Sidebar = ({ isSidebar, setIsSidebar }) => {
  return (
    <>
      <div className={`absolute shadow-md w-64 bg-white/80 top-0 bottom-0 ${isSidebar ? 'left-0 z-50' : '-left-64'} transition-all duration-300 flex flex-col`}>
      ...
      {isSidebar &&
        <div className='absolute -top-16 -bottom-16 right-0 left-0 bg-slate-700/80'>
        </div>
      }
    </>
  );
